...
() {
  ...
  function my_git_formatter() {
    ...
    if (( $1 )); then
      ...
      local       meta='%9F'  # grey foreground
      local      clean='%9F'  # grey foreground
      local   modified='%9F'  # grey foreground
      local  untracked='%9F'  # grey foreground
      local conflicted='%9F'  # grey foreground
    fi
  ...
  # Taskwarrior color.
  typeset -g POWERLEVEL9K_TASKWARRIOR_FOREGROUND=2
