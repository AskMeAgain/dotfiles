...
() {
  ...
  typeset -g POWERLEVEL9K_BACKGROUND=251
 ...
 typeset -g POWERLEVEL9K_RIGHT_SUBSEGMENT_SEPARATOR='%250F\uE0B3'
  ...
  typeset -g POWERLEVEL9K_PROMPT_CHAR_ERROR_{VIINS,VICMD,VIVIS,VIOWR}_FOREGROUND=$SUCCESS_COLOR
  ...
  # Icon color.
  typeset -g POWERLEVEL9K_VCS_VISUAL_IDENTIFIER_COLOR=$SUCCESS_COLOR
  ...
  typeset -g POWERLEVEL9K_VCS_CLEAN_FOREGROUND=$SUCCESS_COLOR
  typeset -g POWERLEVEL9K_VCS_UNTRACKED_FOREGROUND=$SUCCESS_COLOR
  typeset -g POWERLEVEL9K_VCS_MODIFIED_FOREGROUND=$FAIL_COLOR

  ##########################[ status: exit code of the last command ]###########################
  typeset -g POWERLEVEL9K_STATUS_EXTENDED_STATES=true

  typeset -g POWERLEVEL9K_STATUS_OK=true
  typeset -g POWERLEVEL9K_STATUS_OK_FOREGROUND=$SUCCESS_COLOR
  ...
  typeset -g POWERLEVEL9K_MIDNIGHT_COMMANDER_FOREGROUND=$TEXT_COLOR
  ...
  ####################################[ time: current time ]####################################
  # Current time color.
  typeset -g POWERLEVEL9K_TIME_FOREGROUND=$TEXT_COLOR
